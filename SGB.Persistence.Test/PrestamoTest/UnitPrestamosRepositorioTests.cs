...

    {
        public class UnitTestPrestamoRepositoryTests
        {
            ...
            private readonly Mock<ILogger<PrestamoRepository>> _loggerMock;
            ...
            public UnitTestPrestamoRepositoryTests()
            {
                ...
                _loggerMock = new Mock<ILogger<PrestamoRepository>>();
            ...
            private PrestamoRepository CreateRepository(SGBContext context)
            {
                ...
                return new PrestamoRepository(context, loggerFactoryMock.Object, _configMock.Object);
            }
            ...
            public async Task DisableAsync_ShouldReturnSuccess_WhenPrestamoIsDisabled()
            {
               ...
               isbn: "1234567890123"
                ...
                // Verificar que el estado esta activo cambió a false
